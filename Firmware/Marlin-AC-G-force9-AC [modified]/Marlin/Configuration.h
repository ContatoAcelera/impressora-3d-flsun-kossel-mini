...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 101, 101, 101, 108.6956 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 1.61  // Z offset: -below +above  [the nozzle]
